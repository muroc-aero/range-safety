...
(function () {
  ...
  var PROVENANCE_STYLE = [
    ...
    {selector: 'node[kind="conclusion"]', style: kindStyle("#102818", "#40d080", {color: "#a0f0c0", "font-size": 11, width: 150, height: 44, "text-max-width": "140px"})},
    {selector: 'node[kind="conclusion"][verdict="fails"]', style: {"border-color": "#e05050"}},
    {selector: 'node[kind="conclusion"][verdict="partial"]', style: {"border-color": "#e0c040"}},
